        ...
        switch ($form_gabinete) {
        	...
        	case 1:
                ...
                $gabinete = new GabineteElectro($_FILES["gelectro1"]["tmp_name"], $_FILES["gelectro2"]["tmp_name"], 
                                                ...
                                                $_FILES["gelectro5"]["tmp_name"], $_FILES["gelectro6"]["tmp_name"]
                                                );
                $conect = new Conexion();
            ...
            case 4:
                ...
                $rayosx = new GabineteRayosX($_FILES["rayosxi_1"]["tmp_name"], $_FILES["rayosxi_2"]["tmp_name"], 
                                             ...
                                             $_FILES["rayosxi_5"]["tmp_name"], $_FILES["rayosxi_6"]["tmp_name"],
                                             $_FILES["rayosxi_7"]["tmp_name"], $_FILES["rayosxi_8"]["tmp_name"],
                                             $_FILES["rayosxi_9"]["tmp_name"], $_FILES["rayosxi_10"]["tmp_name"]
                                             );
                $conect = new Conexion();
