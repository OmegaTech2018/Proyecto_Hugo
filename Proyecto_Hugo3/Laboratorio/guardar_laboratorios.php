    ...
    <?php
        ...
        switch ($form_laboratorio) {
            ...
            case 1:
                ...
                $eritocitros_vista = $sistema->recuperaPOST("eritocitros_vista","Dato del BH_eritocitros es requerido");
                $hemoglobina_vista = $sistema->recuperaPOST("hemoglobina_vista","Dato del BH_hemoglobina es requerido");
                $hematrocito_vista = $sistema->recuperaPOST("hematrocito_vista","Dato del BH_hematrocito es requerido");
                ...
                $volumen_corpuslar_medio_vista = $sistema->recuperaPOST("volumen_corpuslar_medio_vista","Dato del BH_volumen_corpuslar_medio es requerido");
                ...
                $sql_guarda_laboratorio_QS=sprintf("UPDATE laboratorio_BH SET eritrocitos='$eritocitros_vista', hemoglobina='hemoglobina_vista', hematrocito='hematrocito_vista', plaquetas='plaquetas_vista', leucocitos='leucocitos_vista', volumen_corpuslar_medio='volumen_corpuslar_medio_vista', neutrofilos='neutrofilos_vista', eosinofilos='eosinofilos_vista',bandera=1 
           ...
           /*LABORATORIOS QS*/
            ...
            case 3:
                ...
                /*Insertamos los datos en el laboratorio de EGO*/
                 ...
                 $sql_guarda_laboratorio_QS=sprintf("UPDATE laboratorio_EGO SET densidad='$densidad_vista', PH='ph_vista',celulas_epiteliales='celulas_epiteliales_vista', cristales='cristales_vista', leucocitos='leucocitos_vista', eritrocitos='eritrocitos_vista', glucosa='glucosa_vista', bacterias='bacterias_vista', bandera=1 
