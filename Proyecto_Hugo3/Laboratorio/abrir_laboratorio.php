        ...
        <?php
            switch ($laboratorio) {
                ...
                case 1:
                    ...
                    $bh_id=$_GET['bh_id'];
                    $sql_bh=sprintf("SELECT eritrocitos, hemoglobina, hematrocito, plaquetas, leucocitos, volumen_corpuslar_medio, neutrofilos, eosinofilos FROM laboratorio_BH 
                    ...
                    echo "Hematrocito:<br><br>".$descripcion=$sistema->getBD($sql_bh,"hematrocito")."<br>";
                    ...
                    echo "Volumen Corpuslar Medio:<br><br>".$descripcion=$sistema->getBD($sql_bh,"volumen_corpuslar_medio")."<br>";
                ...
                /*EGO*/
                case 3:
                    echo "<h2>EGO del paciente: ".$Nombre_paciente."</h2>";
                    $ego_id=$_GET['ego_id'];
                ...
                case 4:
                    echo "<h2>Cultivos del paciente: ".$Nombre_paciente."</h2>";
