...
<?php 
    ...
    $Domicilio=$sistema->recuperaPOST("domicilio","Domicilio es requerido");
...
<?php
    $sql_actualiza_paciente=sprintf("UPDATE paciente SET apellido_paterno='$Ap_Paterno', apellido_materno='$Ap_Materno', nombre='$Nombre', edad_paciente=$Edad, embarazo='$Embarazo',
                                     recien_nacido='$Recien_nacido',domicilio='$Domicilio',telefono='$Telefono' WHERE paciente_id=$paciente_id;");
