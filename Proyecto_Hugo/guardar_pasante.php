...
<?php 
    ...
    //echo $nombre.",".$fecha_nacimiento.",".$sexo.",".$escuela.",".$correo.",".$clave;
?>

<?php
    $sql_guardar_pasante=sprintf("INSERT INTO pasante(nombre, fecha_nacimiento, sexo, escuela, email, clave, activo)
                                  VALUES('$nombre','$fecha_nacimiento','$sexo','$escuela','$correo','$clave',1);");
